...
$link = mysqli_connect("localhost", "root", "", "saap");
mysqli_select_db($link, "saap");
//$query_tipo = "SELECT nombre_documento FROM tipo_de_documento ";
$tipo = mysqli_query($link,"SELECT nombre_documento FROM tipo_de_documento ") or die(mysql_error($link));
...
?>
    ...
    <div class="form-group">
        ...
        <input type="text" name="NumeroTelefonico" value="<?php echo $alm->NumeroTelefonico; ?>" class="form-control" placeholder="Ingrese numero de contacto del cliente" required/>
    </div>
    <div class="form-group">
        <label>Correo</label>
